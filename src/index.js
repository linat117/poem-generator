...
function generatePoem(event) {
  ...
  let context =
    "You are a romantic  poem expert and love to write short poems. your mission is to generate a four line poem in basic html. Make sure to follow the user instructions";
